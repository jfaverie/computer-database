...
public class ComputerService {
     ...
     * @param pageNb the page you want
     * @param elemPerPg the number of element per page
     ...
     * @param entity the computer to add in the database
     */
     ...
     * @param entity tge computer to update
     */
